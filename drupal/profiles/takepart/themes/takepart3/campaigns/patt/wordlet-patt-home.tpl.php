<div class="table">
	...
	<div class="item salad">
		...
		<a class="tag" href="/hunger">
			<img src="/profiles/takepart/themes/takepart3/campaigns/patt/images/table-tag-news.png" width="180" height="183" alt="News and Resources" usemap="#news">
		</a>
	</div>
	...
	<div class="item saltpepper">
		...
		<a class="tag" href="<?=wu('patt_film')?>">
			<img src="/profiles/takepart/themes/takepart3/campaigns/patt/images/table-tag-film.png" width="148" height="142" alt="The Film">
		</a>
	</div>
	...
	<div class="item butter">
		...
		<a class="tag" href="<?=wu('patt_book')?>">
			<img src="/profiles/takepart/themes/takepart3/campaigns/patt/images/table-tag-book.png" width="163" height="154" alt="The Book">
		</a>
	</div>
	...
	<div class="item cola">
		...
		<a class="tag" href="<?=wu('patt_alliances')?>">
			<img src="/profiles/takepart/themes/takepart3/campaigns/patt/images/table-tag-alliances.png" width="155" height="151" alt="alliances" usemap="#alliances">
		</a>
	</div>
	...
	<div class="item utensils">
		...
		<a class="tag" href="<?=wu('patt_events')?>">
			<img src="/profiles/takepart/themes/takepart3/campaigns/patt/images/table-tag-events.png" width="162" height="161" alt="Events" usemap="#events">
		</a>
	</div>
	...
	<div class="item bread">
		...
		<a class="tag" href="<?=wu('patt_snap')?>">
			<img src="/profiles/takepart/themes/takepart3/campaigns/patt/images/table-tag-gallery.png" width="161" height="158" alt="Gallery">
		</a>
	</div>
	...
	<div class="item knife">
		...
		<a class="tag" href="<?=wu('patt_assistance')?>">
			<img src="/profiles/takepart/themes/takepart3/campaigns/patt/images/table-tag-assistance.png" width="144" height="142" alt="Assistance">
		</a>
	</div>
	...
	<div class="item dinner">
		...
		<a class="tag" href="<?=wu('patt_action')?>">
			<img src="/profiles/takepart/themes/takepart3/campaigns/patt/images/table-tag-take-action.png" width="157" height="152" alt="Take Action">
		</a>
	</div>
</div>