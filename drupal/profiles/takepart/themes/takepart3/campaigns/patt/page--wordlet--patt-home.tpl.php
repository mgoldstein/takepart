<div id="page-wrapper" class="campaign">
	...
	<script src="http://stage.bltdigital.com/apatt/js/vendor/modernizr-2.6.2.min.js"></script>
		...
		<div class="table int">
			...
			<div class="nav">
				<ul>
					...
					<li><a href="http://stage.bltdigital.com/apatt/alliances.html"><span>alliances</span></a></li>
			...
			<div class="main">
				...
				<div class="column column-2">
					<div class="inner">
				        ...
				        <div class="overview">
				           <h3>IN THEATERS, AVAILABLE ON iTUNES AND onDEMAND MARCH 1ST</h3>
				...
				<div class="column column-3">
					<div class="content">
						<div class="email-signup">
				            ...
				            <div class="submit"><input type="image" value="Submit" src="http://stage.bltdigital.com/apatt/images/interior-form-btn.png"></div>
							</form>
						</div>
						<div class="sponsored">
							<h4>sponsored by:</h4>
    ...
    <script>window.jQuery || document.write('<script src="http://stage.bltdigital.com/apatt/js/vendor/jquery-1.8.3.min.js"><\/script>')</script>

    <script src="http://stage.bltdigital.com/apatt/js/plugins.js"></script>
    <script src="http://stage.bltdigital.com/apatt/js/main.js"></script>
