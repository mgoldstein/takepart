...
// Home
if ( $body.is('.page-wordlet-intelchange-finalists-home') ) {
    var $video_template;
...
// Contest
else if ( $body.is('.page-wordlet-intelchange-finalists-contest') ) {
...
else if ( $body.is('.page-wordlet-intelchange-finalists-contest-enter')) {
...
// About
else if ( $body.is('.page-wordlet-intelchange-finalists-about') ) {
...
// Vote
else if ( $body.is('.page-wordlet-intelchange-finalists-vote') ) {
