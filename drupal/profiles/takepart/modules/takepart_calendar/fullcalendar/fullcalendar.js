		...
		*/	
			...
			"</div>";				
                ...
                */
                ...
                // TakePart Change -----------
                //html +=
                //	"<img src='http://localhost.drupal7/sites/all/modules/takepart_calendar/themes/takepart/images/facebook-16x16.png'/>";	
                //html +=
			...
			*/
            ...
            if ( ua.msie && ua.version.slice(0,1) < "9" ) { // IE8 or lower
                document.createStyleSheet().addRule('.fc-week' + (row + 1), 'display: none;');
            }
            else { // not IE8 or lower
