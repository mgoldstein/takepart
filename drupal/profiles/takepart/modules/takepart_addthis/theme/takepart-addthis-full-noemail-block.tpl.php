...
<div class="takepart_addthis_leftpanel clearfix takepart_addthis_noemail">
  <div class="addthis_toolbox addthis_default_style">
    <a class="addthis_button_facebook_like" fb:like:layout="button_count" fb:like:action="<?php print $variables['takepart_addthis_facebook_like_text'];?>" fb:like:href="<?php echo url(NULL, array('absolute' => TRUE)); ?>"></a>
  ...
  <div class="addthis_toolbox">
    <div class="custom_images">
      <?php print $variables['addthis_custom_buttons_noemail'] ?>
    </div>
  </div>
</div>
