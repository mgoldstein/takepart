...
<div class="takepart_addthis_rightrail clearfix">
  <div class="addthis_share clearfix">
    ...
    <div class="addthis_toolbox addthis_default_style addthis_rightrail_firstrow clearfix">
      <span class="button_container button_fb"><a class="addthis_button_facebook_like" fb:like:layout="button_count" fb:like:action="<?php print $variables['takepart_addthis_facebook_like_text'];?>" fb:like:href="<?php echo url(NULL, array('absolute' => TRUE)); ?>"></a></span>
