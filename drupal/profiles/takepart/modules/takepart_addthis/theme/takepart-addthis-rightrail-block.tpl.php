...
<div class="takepart_addthis_rightrail clearfix">
  <div class="addthis_share clearfix">
    ...
    <div class="addthis_toolbox addthis_default_style addthis_rightrail_firstrow clearfix">
      ...
      <span class="button_container button_twitter"><a class="addthis_button_tweet" tw:via="<?php print $variables['takepart_addthis_tweet_via']; ?>" tw:text="<?php print $node->title; ?>"></a></span>
