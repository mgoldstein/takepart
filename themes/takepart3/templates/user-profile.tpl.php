...
<div class="profile"<?php print $attributes; ?>>
  <?php if ($user_profile['field_registration_email_opt_in']['#object']->name): ?>
    <h1>Hi there, <?php print render($user_profile['field_registration_email_opt_in']['#object']->name); ?></h1>
  <?php endif; ?>
