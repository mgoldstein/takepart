...
function s_doPlugins(s) {
 ...
 /* Removed per 11753 */
  /*		s.eVar30= s.getNewRepeat();*/
	...
	//s.eVar13=s.prop13?s.prop13:'';  Retire -- was previously "Featured Content ID"
	...
	if (s.events.indexOf('event26')>-1){
		if(s.linkType=='o'||s.linkType=='d'||s.linkType=='e'){
			s.prop11=s.eVar14=s.pageName;s.linkTrackVars=s.linkTrackVars+",prop11,eVar14"
		}else{s.prop11=s.eVar14=s.previousPage;}
	}
