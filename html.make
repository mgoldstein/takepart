...
projects[token][patch][] = http://drupal.org/files/issues/691078-462-field_tokens_0.patch
...
projects[brightcove][version] = 2.0-alpha2
projects[media_brightcove][type] = module
projects[media_brightcove][subdir] = contrib
projects[media_brightcove][download][type] = git
projects[media_brightcove][download][branch] = master
projects[media_brightcove][download][url] = git@github.com:phase2/media_brightcove.git
...
projects[omniture][patch][] = http://drupal.org/files/issues/omniture_context_1223462-make.patch
...
libraries[brightcove-php][download][type] = get
libraries[brightcove-php][download][url] = https://download.github.com/BrightcoveOS-PHP-MAPI-Wrapper-2.0.4-0-g237c407.tar.gz
